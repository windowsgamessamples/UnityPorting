...
namespace MyPlugin.Facebook
{
    ...
    public sealed class FacebookGateway
    {
        ...
        public void Initialise(WebBrowser webBrowser)
        {
            if (_web != null)
            {
                _web.LoadCompleted -= WebOnLoadCompleted;
                _web.NavigationFailed -= WebOnNavigationFailed;
            }
        ...
        private void WebOnNavigationFailed(object sender, NavigationFailedEventArgs e)
        {
            ChangeNavigationState(NavigationState.Error);
        }

        private void WebOnLoadCompleted(object sender, NavigationEventArgs e)
        {
